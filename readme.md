...
- [firefox任意版本在HTTP1.0且HTTP状态码为304的情况下, 任何Content-type都会解析为html](./fuzzing-browser-MIME-Sniffing-by-status-code-in-HTTP1.0/readme.md)
- [使用Fuzz的方式对“Chrome XSS Auditor”与“HTTP状态码”的关系进行研究](./fuzzing-Chrome-XSS-Auditor-by-HTTP-status-code/readme.md)
- [Fuzz 尖括号跟什么字符可以使html正常解析？](./fuzzing_char_after_angel_bracket/readme.md)
